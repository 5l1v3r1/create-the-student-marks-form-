...
if(isset($_POST["Gönder"]))
{
    ...
    $db_select = mysql_select_db("notlar");
    if (isset($db_select)) {
    ...
    $ekle = mysql_query("INSERT INTO ogrenciler(no,adı,vize,final,ortalama,durum) VALUES('2','$ad','$vize','$final','$ort','$durum')");
    if (isset($ekle)) {
